...
import os
from main_func import draw_table, get_vacancies_statistic
from headhunter_vacansies import collect_hh_vacancies, predict_rub_salary_hh
from superjob_vacansies import collect_superjob_vacancies, predict_rub_salary_for_superJob
